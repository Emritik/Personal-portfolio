...
export const Projects = () => {
  ...
  const project1 = [
    ...
    {
      title: "Virtual Mall",
      description: "Innvation & Development",
      imgUrl: projImg6,
    },
  ];
  const project2 = [
    {
      title: "Online Patent Registration Desk",
    ...
    {
      title: "Textutils & Customized NotePad",
      description: "Design & Development",
      imgUrl: projImg3,
    },
  ];
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    ...
                    <p><a href="https://github.com/Emritik">More Projects............</a> </p>
                    </Tab.Pane>
                  </Tab.Content>
                </Tab.Container>
              </div>}
